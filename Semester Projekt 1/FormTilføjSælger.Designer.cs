...
{
    partial class FormTilføjSælger
    {
        /// <summary>
        ...
        {
            panel1 = new Panel();
            sælgerOpretOverskriftLabel = new Label();
            sælgerOpretOpretButton = new Button();
            sælgerAnnulerOpretButton = new Button();
            sælgerEmailTextbox = new TextBox();
            sælgerCprNummerTextbox = new TextBox();
            SælgerTelefonNummerTextbox = new TextBox();
            sælgerAdresseTextbox = new TextBox();
            sælgerEfternavnTextbox = new TextBox();
            sælgerFornavnTextbox = new TextBox();
            sælgerEmailLabel = new Label();
            sælgerCprNummerLabel = new Label();
            sælgerTlfNummerLabel = new Label();
            sælgerAdresseLabel = new Label();
            sælgerFornavnLabel = new Label();
            sælgerEfternavnLabel = new Label();
            ...
            panel1.Controls.Add(sælgerAnnulerOpretButton);
            panel1.Controls.Add(sælgerEmailTextbox);
            panel1.Controls.Add(sælgerCprNummerTextbox);
            panel1.Controls.Add(SælgerTelefonNummerTextbox);
            panel1.Controls.Add(sælgerAdresseTextbox);
            panel1.Controls.Add(sælgerEfternavnTextbox);
            panel1.Controls.Add(sælgerFornavnTextbox);
            panel1.Controls.Add(sælgerEmailLabel);
            panel1.Controls.Add(sælgerCprNummerLabel);
            panel1.Controls.Add(sælgerTlfNummerLabel);
            ...
            sælgerOpretOpretButton.Click += sælgerOpretOpretButton_Click;
            // 
        ...
        private Button sælgerOpretOpretButton;
        private Button sælgerAnnulerOpretButton;
        private TextBox sælgerEmailTextbox;
        private TextBox sælgerCprNummerTextbox;
        private TextBox SælgerTelefonNummerTextbox;
        private TextBox sælgerAdresseTextbox;
        private TextBox sælgerEfternavnTextbox;
        private TextBox sælgerFornavnTextbox;
        private Label sælgerEmailLabel;
        private Label sælgerCprNummerLabel;
        private Label sælgerTlfNummerLabel;
        private Label sælgerAdresseLabel;
        private Label sælgerFornavnLabel;
        private Label sælgerEfternavnLabel;
        private Label sælgerOpretOverskriftLabel;
    }
}