...
INSERT INTO Sælger (Fornavn, EfterNavn, Email, TlfNummer, Adresse, CprNummer) VALUES
...
INSERT INTO Køber (Fornavn, EfterNavn, Email, TlfNummer, CprNr, Adresse, PrisKlasse, SøgeOmråde, BoligType, Noter, ØnsketGrundStørrelse, ØnsketBoligStørrelse) VALUES
('Sofie', 'Kristensen', 'sofie.k@email.dk', '11112222', '101022-44', 'Købervej 19', 3000000, 'Aarhus, Skåde, Højbjerg', 'Villa', 'Skal have stor have til børnene', 700, 130),
('Mikkel', 'Hansen', 'mikkel.h@email.dk', '33334444', '101022-44', 'Købervej 19', 2800000, 'Aalborg SV', 'Rækkehus', 'Tæt på skole og offentlig transport', 500, 110),
('Emma', 'Mortensen', 'emma.m@email.dk', '55556666', '101022-44', 'Købervej 19', 2000000, 'Esbjerg C', 'Lejlighed', 'Maksimal energieffektivitet vigtigt', 0, 80);
